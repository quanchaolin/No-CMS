...
for($i=0; $i<count($slide_list); $i++){
    ...
    if($show_edit){
        $edit_link = '<div>'.
                ...
                $origin_uri_string.'"><i class="glyphicon glyphicon-pencil">&nbsp;</i> 当前幻灯片</a>&nbsp;'.
                '<a class="btn btn-primary" href="{{ MODULE_SITE_URL }}manage_slide/index?from='.$origin_uri_string.'"><i class="glyphicon glyphicon-pencil">&nbsp;</i>管理幻灯片</a>'.
            '</div>';
    }
