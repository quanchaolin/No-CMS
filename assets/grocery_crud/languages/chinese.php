...
/* Translated by @heenji */
	...
	$lang['error_on_uploading'] 	= "上载时出错.";
	$lang['message_prompt_delete_file'] 	= "您确定要删除此文件吗？?";

	$lang['error_max_number_of_files'] 	= "每次只能上传一个文件.";
	$lang['error_accept_file_types'] 	= "你不允许上传这种扩展.";
	$lang['error_max_file_size'] 		= "上传文件超过{max_file_size}指定所指定的 .";
