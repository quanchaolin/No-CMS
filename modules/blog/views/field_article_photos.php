...
<input id="md_field_photos_add" class="btn btn-default" type="button" value="添加照片" />
<br />
    ...
    function add_table_row_photos(value){
        ...
        component += '<td>';
            ...
            component += '<div class="pull-right">';
                ...
                // Delete Button
                /////////////////////////////////////////////////////////////////////////////
                component += '<input class="md_field_photos_delete btn btn-default" record_index="'+RECORD_INDEX_photos+'" primary_key="" type="button" value="删除" />';
            component += '</div>';
