...
<script type="text/javascript">
    ...
    function add_table_row_comments(value){
        ...
        component += '<div class="sub-caption">作者</div> : '+comment_name+', '+comment_date;
        component += '<br />';
        component += '<div class="sub-caption">邮箱</div> : '+(comment_email==''?
          '暂缺': '<a href="mailto:'+comment_email+'">'+comment_email+'</a>');
        component += '<br />';
        component += '<div class="sub-caption">网站</div> : '+(comment_website==''?
          '暂缺': '<a href="'+comment_website+'" target="BLANK">'+comment_website+'</a>');
        component += '<br />';
        component += '<div class="sub-caption">审核状态</div> : <span id="comment_approved_'+RECORD_INDEX_comments+'">'+status;
        component += '</div>';
        component += '<div">';
        ...
        component += '<input class="md_field_comments_delete btn btn-default" record_index="'+RECORD_INDEX_comments+'" primary_key="" type="button" value="删除" />';
        component += '</div>';
        component += '<div style="clear:both;"></div>';
    ...
    $(document).ready(function(){
        ...
        $('.toggle_comment_approve').click(function(event){
            ...
            if(record_index_found){
                if(new_val == 0){
                    $(this).html('核准');
                    $('#comment_approved_'+record_index).html('等待核准');
                }else{
                    $(this).html('取消核准');
                    $('#comment_approved_'+record_index).html('核准');
                }
            }
            synchronize_comments();
        });
